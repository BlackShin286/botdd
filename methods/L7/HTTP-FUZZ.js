...
if(!args[0]) {
	...
	.setColor('RANDOM')
	.setTitle('CẢNH BÁO')
	.setDescription("`Mẫu lệnh tấn công .http-fuzz <url> <time>`")
...
if(!args[1]) {
	...
	exec(`node methods/L7/HTTP-FUZZ.js ${host} proxies.txt ${duration} GET`, (error, stdout, stderr) => {
	});
